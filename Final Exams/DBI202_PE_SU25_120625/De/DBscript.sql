...
BEGIN
	ALTER DATABASE [DBI202_HCM_FE_SP25_1] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [DBI202_HCM_FE_SP25_1] SET ONLINE;
	DROP DATABASE [DBI202_HCM_FE_SP25_1];
END

GO

CREATE DATABASE [DBI202_HCM_FE_SP25_1]
GO

USE [DBI202_HCM_FE_SP25_1]
GO
